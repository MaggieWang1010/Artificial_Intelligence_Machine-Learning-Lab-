...
Original file is located at
    https://colab.research.google.com/drive/1dkYm6ptHLwkj2VEtmG5IbROSSMhcs9NV
"""

#Pandas allows importing data of various file formats such as csv, excel etc. 
#It provides various data manipulation operations such as groupby, join, merge, melt, 
#concatenation as well as data cleaning features such as filling, replacing or imputing null value
#-------------------Pandas Basics – Ex1------------------------
import datetime
...
df = pd.read_csv(data_path + 'newcsv2.csv', index_col=0) #index_col=0: disable index column
print(df.head()) 
